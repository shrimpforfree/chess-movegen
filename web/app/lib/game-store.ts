...
export const gameStore = {
  create(mode: GameMode, playerToken: string, aiDepth = 6, customFen?: string, fusionUpgrade?: GameSession["fusionUpgrade"]): GameSession {
    ...
    const session: GameSession = {
      ...
      moves: [],
      mode,
      status: mode === "fusion" ? "waiting" : (mode === "human-vs-ai" || mode === "human-vs-ai-plus" || mode === "auto" ? "in_progress" : "waiting"),
      white: playerToken,
      black: (mode === "human-vs-ai" || mode === "human-vs-ai-plus" || mode === "fusion") ? "ai" : mode === "auto" ? "auto" : null,
      aiDepth,
